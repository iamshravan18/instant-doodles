...
const pages: SitePage[] = [
  ...
  /* ─────────────────────────── ALTERNATIVES (comparison hub) ─────────────────────────── */
  {
    ...
    related: ["/alternatives/doodly", "/alternatives/videoscribe", "/alternatives/animaker", "/features", "/examples"],
    cta: {
      eyebrow: "Weighing your options?",
      title: "See the workflow the comparisons are based on.",
      body: "Explore the AI features and real examples, or open the specific comparison closest to your shortlist above.",
      primaryHref: "/features",
      primaryLabel: "Explore the AI features",
      secondaryHref: "/examples",
      secondaryLabel: "See real examples",
    },
  },
  ...
  /* ─────────────────────────── alternatives/doodly ─────────────────────────── */
  {
    ...
    related: ["/alternatives/videoscribe", "/alternatives/animaker", "/alternatives", "/features", "/examples"],
    cta: {
      eyebrow: "Ready to decide?",
      title: "You've compared the workflow that matters — take the next step.",
      body: "See what a finished doodle video looks like, then verify the current plan details before you commit.",
      primaryHref: "/examples",
      primaryLabel: "See real examples",
      secondaryHref: "/pricing",
      secondaryLabel: "What to verify before buying",
    },
  },
  ...
  /* ─────────────────────────── alternatives/videoscribe ─────────────────────────── */
  {
    ...
    related: ["/alternatives/doodly", "/alternatives/animaker", "/alternatives", "/whiteboard-animation-software", "/educational-video-maker"],
    cta: {
      eyebrow: "Ready to decide?",
      title: "Test the workflow on your own project.",
      body: "Explore the AI features you would actually use, then confirm the plan details that fit your work.",
      primaryHref: "/features",
      primaryLabel: "Explore the AI features",
      secondaryHref: "/pricing",
      secondaryLabel: "What to verify before buying",
  ...
  /* ─────────────────────────── alternatives/animaker ─────────────────────────── */
  {
    ...
    related: ["/alternatives/doodly", "/alternatives/videoscribe", "/alternatives", "/doodle-video-creator", "/whiteboard-video-maker"],
    cta: {
      eyebrow: "Ready to decide?",
      title: "Decide by the videos you actually make.",
      body: "If doodle explainers are your main output, see the workflow in action — then verify the plan that fits.",
      primaryHref: "/doodle-video-creator",
      primaryLabel: "See the doodle workflow",
      secondaryHref: "/pricing",
      secondaryLabel: "What to verify before buying",
